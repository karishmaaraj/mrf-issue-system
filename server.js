...
// Configurable Admin Portal link for completion confirmation pages
function getAdminPortalBaseUrl() {
  ...
  if (completionBase && completionBase.trim()) {
    try {
      ...
      return `${u.protocol}//${u.hostname}:5175`;
    } catch {
      // ignore
    }
  }
        ...
        <body>
          <div class="card">
            ...
            <div class="content">
              ...
              <a href="${getAdminPortalBaseUrl()}/" class="btn">Open Admin Portal</a>
            </div>
          </div>
        </body>
        </html>
        ...
        <body>
          <div class="card">
            ...
            <div class="content">
              ...
              <a href="${getAdminPortalBaseUrl()}/" class="btn">View Admin Portal</a>
            </div>
          </div>
        </body>
        </html>
