        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between px-5 sm:px-8 py-3.5">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="hidden md:flex items-center gap-1.5 text-xs text-slate-700 hover:text-slate-900 font-bold px-3.5 py-2 rounded-xl border border-slate-200 hover:bg-slate-100/80 transition-all duration-200 active:scale-95 bg-white shadow-2xs"
            >
                    ...
                    >
                      <div className="space-y-3">
                        ...
                        <div className="pt-1 flex items-center justify-between gap-2">
                          <span className={`inline-flex items-center gap-1.5 text-xs font-black px-2.5 py-1 rounded-full border shadow-2xs transition-all duration-300 ${isBusy
                  ...
                  {activityLog.length === 0 ? (
                    ...
                    activityLog.map(t => (
                      <div key={t.ticketNo} className="flex items-center justify-between text-xs py-2 px-2.5 rounded-xl hover:bg-slate-50 border-b border-slate-100 last:border-0 transition-colors">
                        ...
                        <span className={`text-[9px] font-black px-2.5 py-0.5 rounded-full shrink-0 ${t.status === 'Completed' ? 'badge-completed' : t.status === 'Ongoing' ? 'badge-ongoing' : 'badge-unsolved'
                          }`}>
                          {t.status}
                        </span>
                      </div>
